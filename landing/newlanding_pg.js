...
function changeCloth(type) {
    console.log('changeCloth:', type);
    const colorInput = document.getElementById('clothColor');
    const color = colorInput ? colorInput.value : '#ff6a3d';
